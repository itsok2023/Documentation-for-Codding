...
const Listcards2 = () => {
  return (
    <div className="h-[11em] w-auto border-2 border-[rgba(0,0,0,0.92)] rounded-[1.5em] bg-stone-300   text-stone-800 font-nunito p-[1em] flex justify-center content-center items-center flex-col-2 gap-[0.75em] backdrop-blur-[12px] md:h-[9em] md:gap-50 ">
      ...
      <div>
        <h1 className="text-[1.5em] font-medium">3. AngularJS + TailwindCSS:</h1>
        <p className="text-[0.85em]">
          - Get AngularJS running with TailwindCSS in just a few steps.
        </p>
      </div>
      <div>
      <button className="text-white bg-blue-900 hover:bg-blue-600 hover:text-white my-auto h-fit w-fit px-[1em] py-[0.25em] border-[1px] rounded-full flex justify-center place-content-center items-center gap-[0.em] overflow-hidden group hover:translate-y-[0.125em] duration-200 backdrop-blur-[12px]">
        <a href='#'>Start</a>
